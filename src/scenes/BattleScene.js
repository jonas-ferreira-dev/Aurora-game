export class BattleScene extends Phaser.Scene {
    ...
    desenharCenario() {
        if (this.phaseData.theme === "street") {
            this.desenharRua();
        } else {
            this.desenharNavio();
        }

        this.streetTop = this.phaseData.top;
        this.streetBottom = this.phaseData.bottom;
    ...
    criarHUD() {
        ...
        this.add.circle(42, 35, 20, 0x3aa0ff).setDepth(1001);

        this.add.text(42, 35, "P", {
            fontSize: "22px",
            color: "#ffffff",
            fontStyle: "bold"
        ...
        this.phaseText = this.add.text(this.w / 2, 18, this.phaseData.nome, {
            fontSize: "24px",
            color: "#ffffaa",
            fontStyle: "bold"
        ...
        this.helpText = this.add.text(20, this.h - 32, "Mover: WASD/setas | Ataque: ESPACO | ENTER: continuar | ESC: menu", {
            fontSize: "18px",
            color: "#ffffff"
        }).setDepth(1001);
    ...
    criarInimigos() {
        ...
        this.phaseData.enemyPositions.forEach((pos) => {
            ...
            enemy.life = this.phaseData.enemyLife;
            enemy.speed = this.phaseData.enemySpeed;
    ...
    criarControles() {
      ...
      this.input.keyboard.on("keydown-ENTER", () => {
            if (this.waitingNextPhase && this.nextSceneKey) {
            ...
            if (this.phaseFinished && !this.nextSceneKey) {
    ...
    mostrarBannerFase() {
        const banner = this.add.text(this.w / 2, this.h / 2 - 120, this.phaseData.nome, {
            fontSize: "38px",
            color: "#ffffff",
  ...
  finalizarFase() {
    ...
    if (this.nextSceneKey) {
        ...
        this.add.text(this.w / 2, this.h / 2 - 20, `${this.phaseData.nome} CONCLUIDA`, {
            fontSize: "44px",
            color: "#44ff88",
            fontStyle: "bold"
        }).setOrigin(0.5).setDepth(2001);

        this.add.text(this.w / 2, this.h / 2 + 38, "ENTER para ir para a proxima fase", {
            fontSize: "26px",
            color: "#ffffff"
        }).setOrigin(0.5).setDepth(2001);
    } else {
        ...
        this.add.text(this.w / 2, this.h / 2 + 38, "ENTER para ver os creditos", {
            fontSize: "26px",
            color: "#ffffff"
        }).setOrigin(0.5).setDepth(2001);
    }
